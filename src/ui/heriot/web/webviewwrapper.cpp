...
QWebEnginePage::FindFlag WebViewWrapper::searchFlags()
{
    return (QWebEnginePage::FindFlag) 0;
}

QWebEnginePage::FindFlag WebViewWrapper::searchFlagsBackwards()
{
    return (QWebEnginePage::FindFlag) (this->searchFlags() & QWebEnginePage::FindBackward);
}
