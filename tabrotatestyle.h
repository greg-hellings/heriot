#ifndef TABROTATESTYLE_H
#define TABROTATESTYLE_H

#include <QProxyStyle>
#include <QPainter>

class TabRotateStyle : public QProxyStyle
{
public:
    explicit TabRotateStyle(Qt::Orientation orientation, QStyle * baseStyle = 0)
                           ...
                           const QSize & size, const QWidget * widget) const
    {
        ...
        s.setWidth(s.width() > 200 ? 200 : s.width());
